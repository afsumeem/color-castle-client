...
const ManageProduct = ({ manage }) => {
    ...
    const handleDeleteProduct = id => {
        const url = `https://color-castle-server.onrender.com/colorCastleServices/${id}`
    ...
    return (
        <>
            ...
            >
                <Card>
                    <Card.Img variant="top" src={picture1} style={{ height: '200px', width: '200px', margin: 'auto', padding: '20px' }} />
